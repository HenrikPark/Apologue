...
void Sandbox2D::OnUpdate(AGE::Timestep ts)
{
...

	{
		...
		AGE::Renderer2D::DrawQuad({ -5.0f, -5.0f, -0.1f }, { 10.0f, 10.0f }, m_CheckerBoardTexture, 10.0f);
		AGE::Renderer2D::DrawQuad({ -0.5f, -0.5f, 0.0f }, { 1.0f, 1.0f }, m_CheckerBoardTexture, 20.0f);
